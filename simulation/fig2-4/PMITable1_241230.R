...
for (k in 1:m){
  ...
  if (k %% 10 == 0) {
    ...
    saveRDS(pvalue_results, file = paste0('/home/zhiweixu/pmi/typeI/pvalues_d',d,'_n',n,'_clen',c_len,'.rds'))
    saveRDS(pvalue_patient_level_results, file = paste0('/home/zhiweixu/pmi/typeI/pvalues_patlevel_d',d,'_n',n,'_clen',c_len,'.rds'))
    ...
    write.csv(min_pvalues_df, file = paste0('/home/zhiweixu/pmi/typeI/minpvalue_d',d,'_n',n,'_clen',c_len,'.csv'), row.names = FALSE)
...
write.csv(min_pvalues_df, file = paste0('/home/zhiweixu/pmi/typeI/final_minpvalue_d',d,'_n',n,'_clen',c_len,'.csv'), row.names = FALSE)
